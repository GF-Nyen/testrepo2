...
spp_plots <- bind_rows(ARBE_plots,TEVI_plots,SOSE_plots,SONU_plots)
...
ggplot(spp_plots, aes(fill=species_code,  y=spp_biomass,  x = factor(stand, levels = c(3, 4, 5, 10, 6, 7, 8, 9)))) + 
    geom_bar(position="stack", stat="identity") +
         scale_x_discrete("stand", drop = FALSE) +
            scale_fill_manual("legend", values = c("ARBE" = "darkgray", "SONU" = "darkviolet", 
                                                   "SOSE" = "pink2", "TEVI"= "darkturquoise"))+
