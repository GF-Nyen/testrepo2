...
```{r}
#This is for stand/transect grouping. So replicates are transects within the stand
...
m4 <- aov(n_seedlings_mean ~ stand, data = stand_transect_summary )
summary(m4)
...
library(glmmADMB)
fit_binary <- glmmadmb(Presence ~ sum_all_species_dried_weight_g,
