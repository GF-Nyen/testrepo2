...
metadata<- read.csv("C:/Users/nyen0010/Downloads/gn_metadata_wzeros.csv") #this is my meta data from the understory community change over time study
...
regendata <- read.csv("C:/Users/nyen0010/Downloads/regenplots.csv") #here is the meta data on the understory regen. This includes height of trees, metadata does not
...
clus <- parallel::makeCluster(13) # creates a cluster using 13 of 14 cores
